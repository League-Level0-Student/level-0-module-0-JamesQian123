...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if(dragonHealth <= 0) {
				...
				// 		dragon have left.
			String health = "You have " + playerHealth +" health and the dragon has "+ dragonHealth+" health left";
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null,"You have been defeated by the dragon and you don't get any treasure ");
		System.exit(0);   //This code ends the program
	}

	static void dragonLost() {
		// 12. Tell the user that the dragon has been defeated and they get a ton of gold!
		JOptionPane.showMessageDialog(null,"The dragon has been defeated, you won a lot of gold");
		System.exit(0);   //This code ends the program
	}
